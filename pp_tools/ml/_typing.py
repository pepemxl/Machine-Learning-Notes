# -*- coding: utf-8 -*-
"""
Created on Sun Oct  2 20:21:48 2022
...
import sys
from typing import (
    Any, # Compatible with every type, basically a helper for annotations
    Callable, # Callable[[int], str] is a function of (int) -> str.
    Dict,
    FrozenSet,
    Iterable,
    Iterator,
...
if sys.version_info >= (3, 9):
    from collections.abc import Collection # ABC for sized iterable container classes.
else:
    from typing import Collection # A generic version of collections.abc.Collection


if TYPE_CHECKING:
    from ml.predicates import Predicate
